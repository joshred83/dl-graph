...
if __name__ == "__main__":
    # Basic test for EllipticBitcoinTemporalDataset
    # run test with 
    # python -m src.local.elliptic_temporal
    # from root directory
    print("Testing EllipticBitcoinTemporalDataset...")
    try:
        dataset = EllipticBitcoinTemporalDataset(root="data/elliptic", t=1)
        data = dataset[0]
        print(f"Loaded data for t=1: nodes={data.num_nodes}, edges={data.num_edges}, features={data.num_features}")
